...
var G__48420_48445 = rewrite_clj.node.protocols.coerce;
var G__48421_48446 = "object";
var G__48422_48447 = (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});
goog.object.set(G__48420_48445,G__48421_48446,G__48422_48447);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__48424_48448 = rewrite_clj.node.protocols.coerce;
var G__48425_48449 = "number";
var G__48426_48450 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});
goog.object.set(G__48424_48448,G__48425_48449,G__48426_48450);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__48427_48454 = rewrite_clj.node.protocols.coerce;
var G__48428_48455 = "string";
var G__48429_48456 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});
goog.object.set(G__48427_48454,G__48428_48455,G__48429_48456);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__48430 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__48430) : f.call(null,G__48430));
})(),sq);
});
...
var comma_48457 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_48458 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__48432){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_48458,rewrite_clj.node.protocols.coerce(v),comma_48457], null);
