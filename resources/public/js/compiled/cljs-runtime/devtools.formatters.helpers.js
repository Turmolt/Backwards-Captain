...
var G__41842 = devtools.prefs.pref(v);
v = G__41842;
continue;
} else {
return v;
...
}catch (e41814){var _e__39250__auto__ = e41814;
return false;
}})();
...
}catch (e41820){var _e__39250__auto__ = e41820;
return false;
}})();
...
}catch (e41823){var _e__39250__auto__ = e41823;
return false;
}}
}
});
...
var vec__41833 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41833,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41833,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41836_SHARP_);
}),template);
});
