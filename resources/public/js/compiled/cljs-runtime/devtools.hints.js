...
var G__39309 = cljs.core.PersistentArrayMap.EMPTY;
var G__39310 = native_stack_trace;
var G__39311 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__39312 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__39309,G__39310,G__39311,G__39312) : cljs.stacktrace.parse_stacktrace.call(null,G__39309,G__39310,G__39311,G__39312));
});
...
var map__39314 = top_item;
var map__39314__$1 = (((((!((map__39314 == null))))?(((((map__39314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__39314):map__39314);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39314__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39314__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39314__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e39313){var _e = e39313;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___39397 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___39397)){
var seen_errors_39398 = temp__5733__auto___39397;
if(cljs.core.truth_(seen_errors_39398.has(self))){
} else {
seen_errors_39398.add(self);

var temp__5735__auto___39399 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___39399)){
var sense_39400 = temp__5735__auto___39399;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39400)].join(''));
} else {
}
}
} else {
