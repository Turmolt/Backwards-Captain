...
var G__48845 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__48845__$1 = (((G__48845 == null))?null:cljs.core.iterate((function (loc){
...
var G__48845__$2 = (((G__48845__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__48845__$1));
var G__48845__$3 = (((G__48845__$2 == null))?null:cljs.core.last(G__48845__$2));
if((G__48845__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__48845__$3);
}
} else {
return zloc;
}
...
var G__48848 = rewrite_clj.zip.move.right(v);
var G__48849 = rewrite_clj.zip.move.up(v);
loc = G__48848;
parent = G__48849;
continue;
} else {
var G__48850 = rewrite_clj.zip.move.right(v0);
var G__48851 = parent;
loc = G__48850;
parent = G__48851;
continue;
...
var G__48852 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__48853 = rewrite_clj.zip.move.up(v);
loc = G__48852;
parent = G__48853;
continue;
} else {
var G__48854 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__48855 = parent;
loc = G__48854;
parent = G__48855;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__48846 = zloc;
var G__48846__$1 = (((G__48846 == null))?null:rewrite_clj.zip.move.down(G__48846));
var G__48846__$2 = (((G__48846__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__48846__$1,k));
if((G__48846__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__48846__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__48847 = rewrite_clj.zip.move.down(zloc);
var G__48847__$1 = (((G__48847 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__48847));
if((G__48847__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__48847__$1);
}
})(),k);
}
});
