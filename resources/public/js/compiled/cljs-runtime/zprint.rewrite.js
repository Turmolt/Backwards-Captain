...
var G__49045 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__49045;
continue;
} else {
var G__49046 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__49046;
continue;
}
} else {
var G__49047 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__49047;
continue;
}
}
...
var G__49029 = zloc;
var G__49030 = (function (){var G__49031 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__49032 = zloc;
var G__49032__$1 = (((G__49032 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__49032) : rewrite_clj.zip.node.call(null,G__49032)));
if((G__49032__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__49032__$1) : zprint.zutil.edn_STAR_.call(null,G__49032__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__49031) : rewrite_clj.zip.root.call(null,G__49031));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__49029,G__49030) : rewrite_clj.zip.replace.call(null,G__49029,G__49030));
});
/**
...
var G__49052 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__49052;
continue;
}
break;
...
var G__49055 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__49056 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__49055;
out = G__49056;
continue;
} else {
...
var G__49058 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__49059 = cljs.core.next(new_loc);
var G__49060 = replaced_loc;
nloc = G__49058;
new_loc = G__49059;
last_loc = G__49060;
continue;
...
return zprint.rewrite.sort_val((function (){var G__49037 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__49037) : rewrite_clj.zip.down.call(null,G__49037));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__49038_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__49038_SHARP_) : rewrite_clj.zip.tag.call(null,p1__49038_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__49038_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__49038_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
