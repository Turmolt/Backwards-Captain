...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__45533_SHARP_,p2__45532_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__45532_SHARP_) : pred.call(null,p2__45532_SHARP_)))){
return p1__45533_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__45535_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__45535_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__45535_SHARP_) <= ending)));
}));
});
...
var len__4789__auto___45574 = arguments.length;
var i__4790__auto___45575 = (0);
while(true){
if((i__4790__auto___45575 < len__4789__auto___45574)){
args__4795__auto__.push((arguments[i__4790__auto___45575]));

var G__45576 = (i__4790__auto___45575 + (1));
i__4790__auto___45575 = G__45576;
continue;
} else {
}
break;
...
(day8.re_frame_10x.utils.utils.pluralize.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__45548){
var vec__45549 = p__45548;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45549,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize.cljs$lang$applyTo = (function (seq45544){
var G__45545 = cljs.core.first(seq45544);
var seq45544__$1 = cljs.core.next(seq45544);
var G__45546 = cljs.core.first(seq45544__$1);
var seq45544__$2 = cljs.core.next(seq45544__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45545,G__45546,seq45544__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___45579 = arguments.length;
var i__4790__auto___45582 = (0);
while(true){
if((i__4790__auto___45582 < len__4789__auto___45579)){
args__4795__auto__.push((arguments[i__4790__auto___45582]));

var G__45584 = (i__4790__auto___45582 + (1));
i__4790__auto___45582 = G__45584;
continue;
} else {
}
break;
...
(day8.re_frame_10x.utils.utils.pluralize_.cljs$core$IFn$_invoke$arity$variadic = (function (num,singular,p__45561){
var vec__45562 = p__45561;
var plural = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45562,(0),null);
...
/** @this {Function} */
(day8.re_frame_10x.utils.utils.pluralize_.cljs$lang$applyTo = (function (seq45558){
var G__45559 = cljs.core.first(seq45558);
var seq45558__$1 = cljs.core.next(seq45558);
var G__45560 = cljs.core.first(seq45558__$1);
var seq45558__$2 = cljs.core.next(seq45558__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45559,G__45560,seq45558__$2);
}));
