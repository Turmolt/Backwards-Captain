...
if((i < len)){
var k = (ks[i]);
var G__50719 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__50720 = (i + (1));
m = G__50719;
i = G__50720;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__50615 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__50615);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50619 = c;
var G__50619__$1 = (((G__50619 == null))?null:G__50619.prototype);
if((G__50619__$1 == null)){
return null;
} else {
return (G__50619__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50622 = c;
var G__50622__$1 = (((G__50622 == null))?null:G__50622.prototype);
if((G__50622__$1 == null)){
return null;
} else {
return (G__50622__$1["render"]);
}
})() == null)))));
});
...
var G__50627 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__50627) : reagent.impl.component.as_element.call(null,G__50627));
};
...
var _STAR_current_component_STAR__orig_val__50628 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__50629 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__50629);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__50628);
}});
...
var c = this;
var G__50654_50728 = (c["cljsRatom"]);
if((G__50654_50728 == null)){
} else {
reagent.ratom.dispose_BANG_(G__50654_50728);
}
...
var renders_50730 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_50731 = cljs.core.first(cljs.core.vals(renders_50730));
if((cljs.core.count(renders_50730) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_50730))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_50731)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_50731], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__50688 = name;
switch (G__50688) {
case "":
...
var G__50692 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__50692);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__50693 = fiber;
var G__50693__$1 = (((G__50693 == null))?null:(G__50693["type"]));
if((G__50693__$1 == null)){
return null;
} else {
return (G__50693__$1["displayName"]);
}
})();
var parent = (function (){var G__50694 = fiber;
if((G__50694 == null)){
return null;
} else {
return (G__50694["return"]);
}
})();
var path = (function (){var G__50695 = parent;
var G__50695__$1 = (((G__50695 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__50695) : reagent.impl.component.fiber_component_path.call(null,G__50695)));
if((G__50695__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50695__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__50697 = c;
if((G__50697 == null)){
return null;
} else {
return (G__50697["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__50698._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__50700 = c;
if((G__50700 == null)){
return null;
} else {
return (G__50700["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__50706 = c;
if((G__50706 == null)){
return null;
} else {
return G__50706._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__50708 = instance;
if((G__50708 == null)){
return null;
} else {
return (G__50708["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__50709 = instance;
if((G__50709 == null)){
return null;
} else {
return G__50709._currentElement;
}
}
})();
var name = (function (){var G__50710 = elem;
var G__50710__$1 = (((G__50710 == null))?null:(G__50710["type"]));
if((G__50710__$1 == null)){
return null;
} else {
return (G__50710__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__50712 = elem;
if((G__50712 == null)){
return null;
} else {
return (G__50712["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__50713._owner;
}
}
})();
var path = (function (){var G__50714 = owner;
var G__50714__$1 = (((G__50714 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__50714) : reagent.impl.component.component_path.call(null,G__50714)));
if((G__50714__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50714__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__50718 = c;
var G__50718__$1 = (((G__50718 == null))?null:G__50718.constructor);
if((G__50718__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__50718__$1);
}
}
})();
