...
var vec__50450 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__50452;
var parts = seq__50451__$1;
...
var self__ = this;
var self__ = this;
var G__50460 = (arguments.length - (1));
switch (G__50460) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args50459){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args50459)));
}));
...
var _STAR_always_update_STAR__orig_val__50469 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__50470 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__50470);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__50469);
}} else {
