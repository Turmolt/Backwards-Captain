...
var G__49137 = new_next_nonws_QMARK_;
index = G__49135;
skip_to_right_QMARK_ = G__49136;
next_nonws_QMARK_ = G__49137;
continue;
}
}
break;
...
var G__49141 = zprint.focus.next_ssv(ssv,index);
var G__49142 = (moves - (1));
index = G__49141;
moves = G__49142;
continue;
}
...
var G__49144 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__49145 = cljs.core.next(nwp);
idx = G__49144;
nwp = G__49145;
continue;
}
...
})())?(function (){var fexpr__49130 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__49130.cljs$core$IFn$_invoke$arity$1 ? fexpr__49130.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__49130.call(null,ssv_next));
