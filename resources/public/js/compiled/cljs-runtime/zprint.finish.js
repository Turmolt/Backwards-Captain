...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__49217_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49217_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__49217_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__49218){
var vec__49219 = p__49218;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49219,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49219,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__49222,s,color,element,idx){
var map__49223 = p__49222;
var map__49223__$1 = (((((!((map__49223 == null))))?(((((map__49223.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49223.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49223):map__49223);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49223__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49223__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49223__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__49227 = (function (){var or__4185__auto__ = color;
...
var fexpr__49226 = (function (){var G__49228 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__49228) : style_map.call(null,G__49228));
})();
return (fexpr__49226.cljs$core$IFn$_invoke$arity$1 ? fexpr__49226.cljs$core$IFn$_invoke$arity$1(G__49227) : fexpr__49226.call(null,G__49227));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__49229){
var vec__49230 = p__49229;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49230,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49230,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49230,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__49233){
var vec__49234 = p__49233;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49234,(2),null);
...
var G__49482 = cljs.core.next(ssv);
var G__49485 = (this_ssv == null);
var G__49486 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49487 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49482;
doing_nil_QMARK_ = G__49485;
last_elide = G__49486;
out = G__49487;
continue;
}
...
var vec__49252 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49252,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49252,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49252,(2),null);
...
var G__49506 = cljs.core.next(remaining_cvec);
var G__49507 = new_idx;
var G__49508 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49506;
idx = G__49507;
out = G__49508;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__49281,cursor_vec){
var vec__49282 = p__49281;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49282,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49282,(1),null);
var focus_vec = vec__49282;
...
var vec__49287 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49287,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49287,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__49293){
var vec__49296 = p__49293;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49296,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49296,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__49311,existing_count){
var vec__49312 = p__49311;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49312,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49312,(1),null);
...
return cljs.core.filterv((function (p1__49304_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__49304_SHARP_))));
...
var vec__49326 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49326,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49326,(1),null);
var cvec_element = vec__49326;
if((cvec_element == null)){
var G__49520 = cljs.core.next(cvec_nl);
var G__49521 = (idx + (1));
var G__49522 = start;
var G__49523 = out;
cvec_nl = G__49520;
...
var G__49525 = (idx + (1));
var G__49526 = idx;
var G__49527 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49524;
idx = G__49525;
start = G__49526;
out = G__49527;
...
var G__49529 = (idx + (1));
var G__49530 = (idx + (1));
var G__49531 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49528;
idx = G__49529;
start = G__49530;
out = G__49531;
...
var G__49532 = cljs.core.next(cvec_nl);
var G__49533 = (idx + (1));
var G__49534 = idx;
var G__49535 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49532;
idx = G__49533;
start = G__49534;
out = G__49535;
...
var G__49536 = cljs.core.next(cvec_nl);
var G__49537 = (idx + (1));
var G__49538 = start;
var G__49539 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49536;
idx = G__49537;
start = G__49538;
out = G__49539;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49330_SHARP_,p2__49329_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__49329_SHARP_)){
return cljs.core.reduced(p1__49330_SHARP_);
} else {
return (p1__49330_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__49334,p__49335){
var vec__49336 = p__49334;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49336,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49336,(1),null);
var vec__49339 = p__49335;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49339,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49339,(1),null);
...
var options = map__49348__$1;
var map__49349 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49348__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49349__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49349__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49349__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49346_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49346_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
