...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48183,else__4442__auto__){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48182){
var self__ = this;
var G__48182__$1 = this;
return (new cljs.core.RecordIter((0),G__48182__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48184,other48185){
var self__ = this;
var this48184__$1 = this;
return (((!((other48185 == null)))) && ((this48184__$1.constructor === other48185.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.tag,other48185.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.wrap_fn,other48185.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.wrap_length,other48185.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.seq_fn,other48185.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.children,other48185.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48184__$1.__extmap,other48185.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__48201 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__48201) : self__.seq_fn.call(null,G__48201));
}));
...
var self__ = this;
var this$__$1 = this;
var G__48202 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__48202) : self__.wrap_fn.call(null,G__48202));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48182){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__48212 = cljs.core.keyword_identical_QMARK_;
var expr__48213 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__48215 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
...
return (new rewrite_clj.node.seq.SeqNode(G__48182,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48217 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__48218 = expr__48213;
return (pred__48212.cljs$core$IFn$_invoke$arity$2 ? pred__48212.cljs$core$IFn$_invoke$arity$2(G__48217,G__48218) : pred__48212.call(null,G__48217,G__48218));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__48182,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48219 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__48220 = expr__48213;
return (pred__48212.cljs$core$IFn$_invoke$arity$2 ? pred__48212.cljs$core$IFn$_invoke$arity$2(G__48219,G__48220) : pred__48212.call(null,G__48219,G__48220));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__48182,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48221 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__48222 = expr__48213;
return (pred__48212.cljs$core$IFn$_invoke$arity$2 ? pred__48212.cljs$core$IFn$_invoke$arity$2(G__48221,G__48222) : pred__48212.call(null,G__48221,G__48222));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__48182,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48223 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__48224 = expr__48213;
return (pred__48212.cljs$core$IFn$_invoke$arity$2 ? pred__48212.cljs$core$IFn$_invoke$arity$2(G__48223,G__48224) : pred__48212.call(null,G__48223,G__48224));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__48182,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48182),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48182){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__48182,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__48186){
var extmap__4478__auto__ = (function (){var G__48229 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48186,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__48186),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__48186),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__48186),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__48186),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48186),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__48234_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__48234_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__48239_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__48239_SHARP_);
}),children);
});
