...
return [(function (){var pred__45886 = cljs.core.instance_QMARK_;
var expr__45887 = reactive_val;
if(cljs.core.truth_((pred__45886.cljs$core$IFn$_invoke$arity$2 ? pred__45886.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__45887) : pred__45886.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__45887)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45886.cljs$core$IFn$_invoke$arity$2 ? pred__45886.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__45887) : pred__45886.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__45887)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45886.cljs$core$IFn$_invoke$arity$2 ? pred__45886.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__45887) : pred__45886.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__45887)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45886.cljs$core$IFn$_invoke$arity$2 ? pred__45886.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__45887) : pred__45886.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__45887)))){
return "tr";
} else {
return "other";
}
