...
var G__42126 = (i__4790__auto___42125 + (1));
i__4790__auto___42125 = G__42126;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42018){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42019,G__42020,seq42018__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42071_SHARP_){
return (!((cljs.core.meta(p1__42071_SHARP_) == null)));
})))){
...
}catch (e42092){var _e__39250__auto__ = e42092;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42097){var _e__39250__auto__ = e42097;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42104 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42105 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42105);

try{var map__42106 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42106__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42104);
}});
...
var temp__5733__auto___42144 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42144)){
var managed_print_level_42145 = temp__5733__auto___42144;
var _STAR_print_level_STAR__orig_val__42111_42146 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42112_42147 = managed_print_level_42145;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42112_42147);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42108_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42108_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42111_42146);
}} else {
job_fn();
}
