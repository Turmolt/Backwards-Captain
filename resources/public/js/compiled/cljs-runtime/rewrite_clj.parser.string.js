...
if((c === "\n")){
var G__48552 = escape_QMARK_;
var G__48553 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__48552;
lines = G__48553;
continue;
} else {
buf.append(c);

var G__48554 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__48555 = lines;
escape_QMARK_ = G__48554;
lines = G__48555;
continue;
...
var G__48548 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__48548) : rewrite_clj.node.string_node.call(null,G__48548));
});
...
var G__48550 = cljs.core.re_pattern(regex);
var G__48551 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__48550,G__48551) : rewrite_clj.node.token_node.call(null,G__48550,G__48551));
});
