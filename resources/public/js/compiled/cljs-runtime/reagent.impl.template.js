...
var G__50727 = o;
(G__50727[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__50763__delegate = function (args){
...
while (G__50764__i < G__50764__a.length) {G__50764__a[G__50764__i] = arguments[G__50764__i + 0]; ++G__50764__i;}
  args = new cljs.core.IndexedSeq(G__50764__a,0,null);
} 
return G__50763__delegate.call(this,args);};
G__50763.cljs$lang$maxFixedArity = 0;
G__50763.cljs$lang$applyTo = (function (arglist__50765){
var args = cljs.core.seq(arglist__50765);
return G__50763__delegate(args);
});
...
var G__50729 = o;
(G__50729[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50768__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50768 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50772__i = 0, G__50772__a = new Array(arguments.length -  0);
while (G__50772__i < G__50772__a.length) {G__50772__a[G__50772__i] = arguments[G__50772__i + 0]; ++G__50772__i;}
  args = new cljs.core.IndexedSeq(G__50772__a,0,null);
} 
return G__50768__delegate.call(this,args);};
G__50768.cljs$lang$maxFixedArity = 0;
G__50768.cljs$lang$applyTo = (function (arglist__50775){
var args = cljs.core.seq(arglist__50775);
return G__50768__delegate(args);
});
...
var G__50734 = props;
var G__50734__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50734,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50734);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50734__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50735){
...
var props = map__50736__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50736__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50738){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50739__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__50742 = jsprops;
(G__50742["defaultValue"] = value);

(G__50742["onChange"] = (function (p1__50741_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50741_SHARP_);
}));
...
var vec__50744 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50744,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50744,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50744,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___50800 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50800 == null)){
} else {
var key_50801 = temp__5739__auto___50800;
(jsprops["key"] = key_50801);
}
...
var temp__5739__auto___50817 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50817 == null)){
} else {
var key_50818 = temp__5739__auto___50817;
reagent.impl.template.oset(jsprops,"key",key_50818);
}
...
var G__50748 = reagent.impl.template.__GT_NativeWrapper();
(G__50748["name"] = c);
...
var G__50749 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50749) : reagent.impl.template.as_element.call(null,G__50749));
} else {
...
var len__4789__auto___50825 = arguments.length;
var i__4790__auto___50826 = (0);
while(true){
if((i__4790__auto___50826 < len__4789__auto___50825)){
args__4795__auto__.push((arguments[i__4790__auto___50826]));

var G__50827 = (i__4790__auto___50826 + (1));
i__4790__auto___50826 = G__50827;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50752){
var G__50753 = cljs.core.first(seq50752);
var seq50752__$1 = cljs.core.next(seq50752);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50753,seq50752__$1);
}));
...
break;
default:
var G__50835 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__50835;
continue;
...
var n__4666__auto___50836 = a.length;
var i_50837 = (0);
while(true){
if((i_50837 < n__4666__auto___50836)){
(a[i_50837] = reagent.impl.template.as_element((a[i_50837])));

var G__50838 = (i_50837 + (1));
i_50837 = G__50838;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___50839 = a.length;
var i_50840 = (0);
while(true){
if((i_50840 < n__4666__auto___50839)){
var val_50841 = (a[i_50840]);
if(((cljs.core.vector_QMARK_(val_50841)) && ((reagent.impl.template.key_from_vec(val_50841) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_50840] = reagent.impl.template.as_element(val_50841));

var G__50844 = (i_50840 + (1));
i_50840 = G__50844;
continue;
} else {
}
...
var ctx = ({});
var vec__50756 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50756,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50756,(1),null);
...
var G__50759 = (cljs.core.count(argv) - first_child);
switch (G__50759) {
case (0):
...
case (1):
var G__50760 = comp;
var G__50761 = jsprops;
var G__50762 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__50760,G__50761,G__50762);
