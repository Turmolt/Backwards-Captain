...
var vec__50168 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__50171 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50171,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50171,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50168,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50168,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__50174){
var vec__50175 = p__50174;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50175,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50175,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50178,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50178,(1),null);
...
var vec__50182 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50182,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50182,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50182,(2),null);
var vec__50185 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50185,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50185,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50185,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__50189){
var vec__50190 = p__50189;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50190,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50190,(1),null);
...
var vec__50196 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50196,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50196,(1),null);
...
var G__50199 = zprint.core.parse_string_all_options(rest_options);
var G__50200 = zprint.core.czprint_str_internal;
var G__50201 = ":parse-string-all? call";
var G__50202 = (function (){var G__50203 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50203) : zprint.zutil.edn_STAR_.call(null,G__50203));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__50199,G__50200,G__50201,G__50202) : zprint.core.process_multiple_forms.call(null,G__50199,G__50200,G__50201,G__50202));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__50204 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50204,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50204,(1),null);
...
/** @this {Function} */
(zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq50193){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50194,G__50195,seq50193__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___50281 = arguments.length;
var i__4790__auto___50282 = (0);
while(true){
if((i__4790__auto___50282 < len__4789__auto___50281)){
args__4795__auto__.push((arguments[i__4790__auto___50282]));

var G__50284 = (i__4790__auto___50282 + (1));
i__4790__auto___50282 = G__50284;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq50209){
var G__50210 = cljs.core.first(seq50209);
var seq50209__$1 = cljs.core.next(seq50209);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50210,seq50209__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___50285 = arguments.length;
var i__4790__auto___50286 = (0);
while(true){
if((i__4790__auto___50286 < len__4789__auto___50285)){
args__4795__auto__.push((arguments[i__4790__auto___50286]));

var G__50287 = (i__4790__auto___50286 + (1));
i__4790__auto___50286 = G__50287;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq50216){
var G__50217 = cljs.core.first(seq50216);
var seq50216__$1 = cljs.core.next(seq50216);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50217,seq50216__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___50288 = arguments.length;
var i__4790__auto___50289 = (0);
while(true){
if((i__4790__auto___50289 < len__4789__auto___50288)){
args__4795__auto__.push((arguments[i__4790__auto___50289]));

var G__50290 = (i__4790__auto___50289 + (1));
i__4790__auto___50289 = G__50290;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq50221){
...
var args__4795__auto__ = [];
var len__4789__auto___50291 = arguments.length;
var i__4790__auto___50292 = (0);
while(true){
if((i__4790__auto___50292 < len__4789__auto___50291)){
args__4795__auto__.push((arguments[i__4790__auto___50292]));

var G__50293 = (i__4790__auto___50292 + (1));
i__4790__auto___50292 = G__50293;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq50223){
var G__50224 = cljs.core.first(seq50223);
var seq50223__$1 = cljs.core.next(seq50223);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50224,seq50223__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__50226,form){
var vec__50227 = p__50226;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(3),null);
...
var vec__50235 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50235,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50235,(1),null);
...
var forms = (function (){var G__50241 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50241) : zprint.zutil.edn_STAR_.call(null,G__50241));
})();
...
var out_str = zprint.core.process_multiple_forms(pmf_options__$1,zprint.core.czprint_str_internal,zprint_specifier,forms);
